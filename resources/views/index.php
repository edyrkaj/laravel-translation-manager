...
<head>
    ...
    <style>
        ...
        .editable-input textarea {width: 700px!important;}
    </style>
...
<div style="width: 80%; margin: auto;">
    <h1>Ezcelip - Translation Manager</h1>
    <p>Warning, translations are not visible until they are exported back to the app/lang file, using 'php artisan translation:export' command or <b>publish</b> button.</p>
    <p style="color: darkred;">Please do not change <b>:parameter</b> or <b>{{parameter}}</b> values on text content</p>
